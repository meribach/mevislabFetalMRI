...
mialsrtkCorrectBiasFieldWithMotionApplied::mialsrtkCorrectBiasFieldWithMotionApplied(const char* _inputFileName, const char* _maskFileName, const char* _transformFileName, const char* _inBiasFieldFileName, const char* _outImageFileName, const char* _outBiasFieldFileName)
{
...
mialsrtkCorrectBiasFieldWithMotionApplied::~mialsrtkCorrectBiasFieldWithMotionApplied()
{

}

bool mialsrtkCorrectBiasFieldWithMotionApplied::RunBiasCorrectionWithMotionApplied() 
{
    ...
    typedef itk::ContinuousIndex<double, Dimension3D> ContinuousIndexType;
	...
	{
		throw "error opening in Bias Field";
		return false;
	}
	...
	{
		throw "error opening in transform file";
		return false;
	}
	...
	{
		throw "error writing out image file";
		return false;
	}
	...
	{
		throw "error writing out bias file";
		return false;
	}
