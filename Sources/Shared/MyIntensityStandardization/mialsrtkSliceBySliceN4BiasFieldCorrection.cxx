...
SliceBySliceN4BiasFieldCorrection::SliceBySliceN4BiasFieldCorrection(const char* const _inputImageFile, const char* const _inputMaskFile, const char* const _outputImageFile, const char* const _outputBiasFile)
{
...
SliceBySliceN4BiasFieldCorrection::~SliceBySliceN4BiasFieldCorrection()
{

}

bool SliceBySliceN4BiasFieldCorrection::runSliceBySliceN4BiasFieldCorrection()
{
	...
	//for now I parallelize on inpout images
	...
	{
		throw "error writing outputImageFile";
		return false;
	}
	...
	{
		throw "error writing outputBiasFile";
		return false;
	}
